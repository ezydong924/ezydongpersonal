...
const THUMB_BASE = "/xishuangbanna/thumbs";
const LIGHTBOX_BASE = "/xishuangbanna/lightbox";
...
export default function XishuangbannaGallery() {
  ...
  return (
    <div className="relative h-screen w-full bg-[#0a0a0c] overflow-hidden">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-50 pointer-events-none text-white/30 text-xs tracking-[0.2em]">暂无照片</div>
