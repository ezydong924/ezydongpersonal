...
export default function Page() {
  return (
    <div className="relative min-h-screen">
      <ZinePosterBackground poster="/assets/atlas/posters/xishuangbanna-zine-v2.png" alt="西双版纳城市影笺" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center px-6 py-20">
        <div className="w-full max-w-2xl">
          ...
          <motion.div className="space-y-6 text-white/55 text-lg leading-relaxed" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }}>
            ...
            <p>植物园给人的感觉完全不一样。进去之后，周围一下子安静下来。热带植物挤在一起，缠在一起，从别的树干上冒出来，又从高处垂下去。藤蔓绕着树往上爬，叶子一层压着一层，大得有点不讲道理。我坐在草地边一截倒下的朽木上。阳光从叶子缝里漏下来，在脚边碎成一块一块的亮斑。那一刻我突然不太想拍照了。人很少，风也轻。植物就在那儿长着，不管你从哪里来，也不管你什么时候走。我坐了一会儿，什么都没干，只是看着叶子晃。那种舒服是人突然慢下来的那种舒服。</p>
            <p>版纳的味道也很让人记得住。撒撇米线的苦味一开始有点出乎意料。它带着青草一样的苦，被酸和辣包着，从舌根慢慢返上来。吃到后面，竟然在闷热里吃出一点清凉。星光夜市旁边那家711也让我印象很深。刚从人潮里挤出来，推开玻璃门，冷气一下子罩下来。货架上有很多平时少见的零食，泰式奶茶也意外好喝。那种感觉很奇怪，前一秒还在夜市里闻着小米辣和烧烤烟，下一秒就站在冷气很足的便利店里喝泰式奶茶。版纳就是这样。它有江风、植物、夜市和潮湿的空气，也有便利店、电动车、和很普通的晚上。远方感里也有很日常的部分。</p>
