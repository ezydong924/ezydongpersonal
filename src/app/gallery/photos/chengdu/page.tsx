      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center px-6 py-20">
        <div className="w-full max-w-2xl">
          ...
          <motion.div className="space-y-6 text-white/55 text-lg leading-relaxed" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }}>
            <p>都江堰的水从鱼嘴分开。安澜索桥上挤满了人，导游的喇叭声在空气里撞来撞去——但水没有声音。它被分开了两千年，早就习惯了。站在离堆公园往下看，水流得不急不慢，甚至不像在流，像在渗，往平原的每一寸缝隙里渗。两岸的石头被磨得光滑，不是被水砸的，是被水摸的——摸了整整两千年。</p>
            <p>青城山的前山道观藏在古树深处。雨后天晴的青城山似乎生命力更加旺盛，几缕微光打在长满了青苔的石阶上，有种曲径通幽处的感觉。道士坐在一旁的木凳上，我沿着石阶向上，随着微光的指引看到了道士在用一针一线缝着什么，香客从面前过也只是做着手中的工作，我用相机记录了这一刻（见视频页）。山里的安静不是被制造出来的，是积蕴出来的——鸟叫和水声叠在一起，奏成了一种比安静更躁动比喧闹更平淡的阴阳调和交响乐。</p>
            <p>后来在成都市里遇上一场雨。细细的，安静的。空气潮湿，带着树叶和泥土混在一起的味道。站在屋檐下躲雨的时候想起青城山。原来雨也知道怎么安静。它不催你不赶你，也只是在做自己的事。</p>
          ...
          <motion.div className="mt-12" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }}>
            <Link href="/gallery/photos/chengdu/gallery" className={linkClass}>翻开影笺<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg></Link>
          </motion.div>
        </div>
      </div>
    </div>
