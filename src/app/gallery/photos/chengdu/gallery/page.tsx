...
// UA 不会变化——空订阅 + 快照即可,服务端渲染取 false,避免 hydration 不一致
const subscribeNoop = () => () => {};
const getIsMobile = () =>
...
export default function ChengduGallery() {
  ...
  return (
    <div className="relative h-screen w-full bg-[#0a0a0c] overflow-hidden">
      <GalleryPosterBackground poster="/assets/atlas/gallery-backgrounds/chengdu-gallery-bg.webp" mobilePoster="/assets/atlas/posters/chengdu-zine-v2.webp" alt="成都影笺背景" />
