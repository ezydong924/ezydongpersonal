  ...
  return (
    <div className="relative h-screen w-full bg-[#0a0a0c] overflow-hidden">
      <div className="fixed top-8 left-8 z-50">
        <BackButton href="/gallery/photos/chengdu" label="返回" />
      </div>
      ...
      <AnimatePresence>
        {showTitle && (
          ...
          >
            <h1
              className="font-bold tracking-[0.2em] select-none"
              style={{
      ...
      <InfiniteGallery
        ...
        speed={0.6}
        fadeSettings={{
          fadeIn: { start: 0.03, end: 0.15 },
          fadeOut: { start: 0.78, end: 0.92 },
        }}
        blurSettings={{
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-50 pointer-events-none text-white/30 text-xs tracking-[0.2em]">
        滚轮浏览 · 自动播放 · 点击看大图
      </div>
      ...
      <AnimatePresence>
        {active !== null && (
          ...
          >
            ...
            <motion.img
              src={`${LIGHTBOX_BASE}/${PHOTOS[active]}`}
              alt=""
