...
export default function ChengduGallery() {
  ...
  return (
    <div className="relative h-screen w-full bg-[#0a0a0c] overflow-hidden">
      <GalleryPosterBackground poster="/assets/atlas/gallery-backgrounds/chengdu-gallery-bg.png" mobilePoster="/assets/atlas/posters/chengdu-zine-v2.png" alt="成都影笺背景" />
