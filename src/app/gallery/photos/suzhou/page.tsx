...
export default function Page() {
  return (
    <div className="relative min-h-screen">
      <ZinePosterBackground poster="/assets/atlas/posters/suzhou-zine-v2.png" alt="苏州城市影笺" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center px-6 py-20">
        <div className="w-full max-w-2xl">
          <motion.h1 className="text-4xl font-light tracking-wide text-white/80 mb-12" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>苏州</motion.h1>
