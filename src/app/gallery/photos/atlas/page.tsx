...
const atlasCities: AtlasCity[] = [
  { slug: "diqing", name: "迪庆州", en: "DIQING", x: 14, y: 35, note: "高处的光，还在整理" },
  { slug: "lijiang", name: "丽江", en: "LIJIANG", x: 24, y: 47, note: "一段尚未成册的停留" },
  ...
  { slug: "dali", name: "大理", en: "DALI", x: 31, y: 63, image: "/dali-cover.jpg", note: "风从画面外面经过" },
  { slug: "kunming", name: "昆明", en: "KUNMING", x: 36, y: 79, note: "还没有决定从哪一张开始" },
  ...
  { slug: "chongqing", name: "重庆", en: "CHONGQING", x: 50, y: 58, note: "坡道、雾气和没剪完的夜" },
  ...
  { slug: "dalian", name: "大连", en: "DALIAN", x: 89, y: 9, image: "/dalian.jpg", note: "风很亮，海把城市推得更远" },
];
...
const developedCount = atlasCities.filter((city) => city.frames).length;
...
export default function MemoryAtlasPrototype() {
  ...
  const activeConnections = links.filter(
      ...
      <header className="atlas-header relative z-30 flex items-start justify-between px-5 pb-4 pt-6 sm:px-8 sm:pt-8 lg:px-10">
        ...
        <div className="atlas-system-head">
          ...
          <div>
            ...
            <strong>{String(atlasCities.length).padStart(2, "0")} / {String(developedCount).padStart(2, "0")} DEVELOPED</strong>
          </div>
        </div>
      </header>
        ...
        <div className="atlas-intro mb-5 grid gap-5 border-b border-white/[0.08] pb-5 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
          ...
          <div className="atlas-intro-meta">
            ...
            <div>
              ...
              <span><b>{String(developedCount).padStart(2, "0")}</b> DEVELOPED</span>
            </div>
          </div>
        </div>
