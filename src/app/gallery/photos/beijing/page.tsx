...
export default function Page() {
  return (
    <div className="relative min-h-screen">
      <ZinePosterBackground poster="/assets/atlas/posters/beijing-zine-v2.png" alt="北京城市影笺" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center px-6 py-20">
        <div className="w-full max-w-2xl">
          ...
          >
            ...
            <p>天坛的国槐让我看见了一草一木的生机。几十棵百年老树搭成天然的遮阳廊道，树干粗壮，枝不往高处长，横着伸出去，像把时间的方向掰歪了。树下的人总在变换，但天坛一直在那里。国槐和一般的树不一样——它不急。一根枝朝一个方向伸出去可能要十年，十年在它眼里不算什么。它见过明朝的落日、清朝的雪、民国换旗那天的风。什么都没说过，但什么都记得。北京最老的居民，或许是这些站着不动的树。它们什么都不说，但你站在下面，就会觉得有些东西确实被它们记住了。</p>
