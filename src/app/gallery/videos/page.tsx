...
export default function VideosPage() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      <StarsBackground speed={60} starColor="rgba(255,255,255,0.6)" className="!fixed inset-0 z-0" />
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-24">
        <motion.div
          className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10"
