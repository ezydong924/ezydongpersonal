(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,31776,e=>{"use strict";var t=e.i(43476),i=e.i(71645);let r=`#version 300 es
...
}`;function A(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}async function l(e){let t={},i=[];return Object.entries(e).forEach(([e,r])=>{if("string"==typeof r){let o=r||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch{return!1}})(o))return void console.warn(`Uniform "${e}" has invalid URL "${o}". Skipping image loading.`);let s=new Promise((i,r)=>{let s=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}})(o)&&(s.crossOrigin="anonymous"),s.onload=()=>{A(s),t[e]=s,i()},s.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},s.src=o});i.push(s)}else r instanceof HTMLImageElement&&A(r),t[e]=r}),await Promise.all(i),t}let h=(0,i.forwardRef)(function({fragmentShader:e,uniforms:r,webGlContextAttributes:o,speed:a=0,frame:n=0,width:A,height:h,minPixelRatio:g,maxPixelCount:c,mipmaps:u,style:m,...B},p){var f;let d,E,[w,x]=(0,i.useState)(!1),Q=(0,i.useRef)(null),v=(0,i.useRef)(null),S=(0,i.useRef)(o);(0,i.useEffect)(()=>((async()=>{let t=await l(r);Q.current&&!v.current&&(v.current=new s(Q.current,e,t,S.current,a,n,g,c,u),x(!0))})(),()=>{v.current?.dispose(),v.current=null}),[e]),(0,i.useEffect)(()=>{let e=!1;return(async()=>{let t=await l(r);e||v.current?.setUniforms(t)})(),()=>{e=!0}},[r,w]),(0,i.useEffect)(()=>{v.current?.setSpeed(a)},[a,w]),(0,i.useEffect)(()=>{v.current?.setMaxPixelCount(c)},[c,w]),(0,i.useEffect)(()=>{v.current?.setMinPixelRatio(g)},[g,w]),(0,i.useEffect)(()=>{v.current?.setFrame(n)},[n,w]);let I=(f=[Q,p],d=i.useRef(void 0),E=i.useCallback(e=>{let t=f.map(t=>{if(null!=t){if("function"==typeof t){let i=t(e);return"function"==typeof i?i:()=>{t(null)}}return t.current=e,()=>{t.current=null}}});return()=>{t.forEach(e=>e?.())}},f),i.useMemo(()=>f.every(e=>null==e)?null:e=>{d.current&&(d.current(),d.current=void 0),null!=e&&(d.current=E(e))},f));return(0,t.jsx)("div",{ref:I,style:void 0!==A||void 0!==h?{width:"string"==typeof A&&!1===isNaN(+A)?+A:A,height:"string"==typeof h&&!1===isNaN(+h)?+h:h,...m}:m,...B})});h.displayName="ShaderMount";let g={fit:"none",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},c={none:0,contain:1,cover:2};function u(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:B;if("string"!=typeof e)return B;let t,i,r,o=1;if(e.startsWith("#")){var s;[t,i,r,o]=(3===(s=(s=e).replace(/^#/,"")).length&&(s=s.split("").map(e=>e+e).join("")),6===s.length&&(s+="ff"),[parseInt(s.slice(0,2),16)/255,parseInt(s.slice(2,4),16)/255,parseInt(s.slice(4,6),16)/255,parseInt(s.slice(6,8),16)/255])}else if(e.startsWith("rgb")){let s;[t,i,r,o]=(s=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(s[1]??"0")/255,parseInt(s[2]??"0")/255,parseInt(s[3]??"0")/255,void 0===s[4]?1:parseFloat(s[4])]:[0,0,0,1]}else{let s;if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),B;[t,i,r,o]=function(e){let t,i,r,[o,s,a,n]=e,A=o/360,l=s/100,h=a/100;if(0===s)t=i=r=h;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,o=h<.5?h*(1+l):h+l-h*l,s=2*h-o;t=e(s,o,A+1/3),i=e(s,o,A),r=e(s,o,A-1/3)}return[t,i,r,n]}((s=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(s[1]??"0"),parseInt(s[2]??"0"),parseInt(s[3]??"0"),void 0===s[4]?1:parseFloat(s[4])]:[0,0,0,1])}return[m(t,0,1),m(i,0,1),m(r,0,1),m(o,0,1)]}let m=(e,t,i)=>Math.min(Math.max(e,t),i),B=[0,0,0,1],p=`
